    <section>
        <div class="row fix" id="formContainer">
                    ...
                    <div class="panel panel-default" >
                        ...
                        <div id="personalInfoTarget" class="panel-collapse collapse" role="tabpanel" aria-labelledby="personalInfo">
                            <div class="panel-body">
                                <form id="infoPersonalForm" class="form-horizontal">
    ...
    <!--      Informacion ubicación                                                                                 -->
                    <div class="panel panel-default">
                        ...
                        <div id="locationInfoTarget" class="panel-collapse collapse" role="tabpanel" aria-labelledby="locationInfo">
                            <div class="panel-body">
                                <form id="infoUbicacionForm" class="form-horizontal">
        ...
        <!--Informacion empresa                                                                                             -->
                    <div class="panel panel-default">
                        ...
                        <div id="companyRatingTarget" class="panel-collapse collapse" role="tabpanel" aria-labelledby="companyRating">
                            <div class="panel-body">
                                <form id="infoClasificacionEmpresaForm" class="form-horizontal">
                                    <div class="form-group col-md-12">
                                        <label class="col-md-3">
                                            Actividad economica
                                        </label>
                                        <div class="col-md-3">
                                            <select class="form-control" id="tipoDeActividad" name="titletipoActividad">
                                                <option value=""></option>
                                                <option value="1">
                                                    Servicios
                                                </option>
        ...
        <!--        Encuesta                                                                                -->
                    <div class="panel panel-default">
                        ...
                        <div id="quizTarget" class="panel-collapse collapse" role="tabpanel" aria-labelledby="quiz">
                            <div class="panel-body">
                                <form id="infoEncuestaGenerarForm" class="form-horizontal">
                                    <div class="form-group">
                                        <label class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="ciiuTarget1" class="ifHeHas">
                                            ...
                                            <div class="col-md-2">
                                                <input class="form-control" type="text" name="fechaciiu" disabled="disabled">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div id="industComerTarget1" class="ifHeHas">
                                            ...
                                            <div class="col-md-4">
                                                <input class="form-control" type="text" name="fechaIndusComercio" disabled="disabled">
                                            </div>
                                        </div>
                                    </div>
                                    <div  class="form-group">
            ...
            <!--Información adicional                                                                               -->
                    <div id="selectTipoOrgTarget"class="panel panel-default ifHeHas">
                        ...
                        <div id="adInfoCond" class="panel-collapse collapse" role="tabpanel" aria-labelledby="adInfo">
                            <div class="panel-body">
                                <form id="infoVendedoresAmbulantesForm" class="form-horizontal">
                                    <div class="form-group">
                                        <label class="col-md-4">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="infoSeguridadTarget" class="panel-collapse collapse" role="tabpanel" aria-labelledby="infoSeguridad">
                            <div class="panel-body">
                                <form id="infoSeguridadForm" class="form-horizontal">
                                    <div class="form-group">
                                        <label class="col-md-4">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="infoMaquilaTarget" class="panel-collapse collapse" role="tabpanel" aria-labelledby="infoMaquila">
                            <div class="panel-body">
                                <form id="infoMaquilaForm" class="form-horizontal">
                                    <div class="form-group">
                                        <label class="col-md-4">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="infoEncuestado" class="panel-collapse collapse" role="tabpanel" aria-labelledby="infoEncuestado">
                            <div class="panel-body">
                                <form id="infoPersonaEncuestadaForm" class="form-horizontal">
                                    <div class="form-group col-md-12">
                                        <label class="col-md-2">
                                            Numero de cedula
                                        </label>
            ...
            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id="modalContainerSendData">
    ...
    <script type="text/javascript" src="../../js/sendDataForUpdate.js"></script>
